...
public class MetalStaticImageSource {
    /// Image consumers
    ...
    public func transmitTexture() {
        ...
        lock.signal()
        let output = MetalDefaultTexture(metalTexture: texture)
...
extension MetalStaticImageSource: MetalImageSource {
    @discardableResult
